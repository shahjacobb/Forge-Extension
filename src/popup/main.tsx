...
const App = () => {
  ...
  if (!state) {
    return <main className="app loading">Preparing Miqat</main>;
  }
        ...
        <header className="topbar">
          <div className="brand">
            ...
            <div className="brand-copy">
              <div className="brand-name">Miqat</div>
          ...
          <section className="view">
            ...
            <section className="account-card">
              <div className="account-header">
                ...
                <h2>{authUser ? "Synced across Chrome profiles" : "Use Miqat on every profile"}</h2>
                <p className="lede">
                  {cloudConfigured
